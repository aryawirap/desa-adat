<nav x-data="{ mobileOpen: false }" class="sticky top-0 z-50 bg-white shadow-sm">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden lg:flex lg:items-center lg:space-x-2">
                <a href="{{ url('/') }}" class="text-gray-700 hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium transition-colors">Beranda</a>
                ...
                <div x-data="{ open: false }" class="relative">
                    ...
                    <div x-show="open" 
                        ...
                        <a href="{{ route('public.visi-misi') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-blue-600">Visi & Misi</a>
                        {{-- Arahkan ke route 'public.sejarah' yang akan kita buat --}}
                        <a href="{{ route('public.sejarah') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-blue-600">Sejarah Desa</a>
                    </div>
                </div>
                ...
                <a href="{{-- route('public.berita') --}}" class="text-gray-700 hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium transition-colors">Berita</a>
            ...
            <div class="flex items-center lg:hidden">
                <button @click="mobileOpen = !mobileOpen" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-700 hover:bg-gray-100 focus:outline-none">
                    ...
                    <svg x-show="!mobileOpen" class="block h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16m-7 6h7"></path></svg>
                    <svg x-show="mobileOpen" class="block h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg>
                </button>
            </div>
        </div>
    </div>
    ...
    <div x-show="mobileOpen"
         ...
         @click.away="mobileOpen = false" x-cloak>
        
        {{-- Overlay --}}
        <div class="fixed inset-0 bg-black/30"></div>

        {{-- Konten Menu --}}
        <div class="relative w-64 h-full bg-white p-4 space-y-2">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-xl font-bold">Menu</h3>
                <button @click="mobileOpen = false" class="p-1">&times;</button>
            </div>

            <a href="{{ url('/') }}" class="block text-gray-700 hover:text-blue-600 py-2 rounded-md font-medium">Beranda</a>
            ...
            <div x-data="{ open: false }">
                ...
                <div x-show="open" class="pl-4 mt-1 space-y-1">
                    <a href="{{ route('public.visi-misi') }}" class="block text-sm text-gray-600 hover:text-blue-600 py-1">Visi & Misi</a>
                    <a href="#" class="block text-sm text-gray-600 hover:text-blue-600 py-1">Sejarah Desa</a>
                    <a href="#" class="block text-sm text-gray-600 hover:text-blue-600 py-1">Peta Wilayah</a>
                </div>
            </div>
            ...
            <div x-data="{ open: false }">
                ...
                <div x-show="open" class="pl-4 mt-1 space-y-1 overflow-y-auto max-h-48">
                    <a href="#" class="block text-sm text-gray-600 hover:text-blue-600 py-1">Struktur Organisasi</a>
                    <a href="#" class="block text-sm text-gray-600 hover:text-blue-600 py-1">LPD</a>
                    <a href="#" class="block text-sm text-gray-600 hover:text-blue-600 py-1">PECALANG</a>
            ...
            <a href="{{-- route('public.berita') --}}" class="block text-gray-700 hover:text-blue-600 py-2 rounded-md font-medium">Berita</a>
